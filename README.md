...
Задание:Реализовать классы контейнер и итератор для работы с двумерным массивом. Реализовать класс алгоритма, в котором определить методы  поиска и сортировки двумерного массива. Выполнить программу.
